...
from cadet.config import add_cadet_config
from cadet.data.custom_build_augmentation import build_custom_augmentation
from cadet.data.custom_dataset_dataloader import  build_custom_train_loader
from cadet.data.custom_dataset_mapper import CustomDatasetMapper, DetrDatasetMapper
from cadet.custom_solver import build_custom_optimizer
from cadet.evaluation.oideval import OIDEvaluator
from cadet.evaluation.custom_coco_eval import CustomCOCOEvaluator
from cadet.modeling.utils import reset_cls_test
...
def setup(args):
    ...
    setup_logger(output=cfg.OUTPUT_DIR, \
        distributed_rank=comm.get_rank(), name="cadet")
    return cfg
