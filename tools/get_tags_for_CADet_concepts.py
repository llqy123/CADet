...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', default='datasets/cc3m/CADet/nouns_train_image_info_6250tags.json')
    parser.add_argument('--keep_images', action='store_true')
    parser.add_argument('--allcaps', action='store_true')
    parser.add_argument('--cat_path', default='datasets/cc3m/CADet/googlecc_nouns_6250.txt')
