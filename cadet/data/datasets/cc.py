...
_CUSTOM_SPLITS = {
    ...
    "all_cc3m_v1_train_tags": ("cc3m/training/", "cc3m/all_train_image_info_tags_full.json"),
    "cc3m_v1_nouns_train_6250tags": ("cc3m/training/", "cc3m/CADet/nouns_train_image_info_6250tags.json"),
