...
def get_detection_dataset_dicts_with_source(
    ...
    if proposal_files is not None:
        dataset_dicts_proposals = []
        for dataset_i_dicts, proposal_i_files in zip(dataset_dicts, proposal_files):
            dataset_dicts_proposals.append(load_proposals_into_dataset(dataset_i_dicts, proposal_i_files))
        dataset_dicts = list(itertools.chain.from_iterable(dataset_dicts_proposals))
    else:
...
def load_proposals_into_dataset(dataset_dicts, proposal_file):
    ...
    for record in dataset_dicts:
        ...
        inds = objectness_logits.argsort()
