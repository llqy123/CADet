...
def add_cadet_config(cfg):
    ...
    _C.MODEL.ROI_BOX_HEAD.USE_CAPTION = True
    _C.MODEL.ROI_BOX_HEAD.DIS_LOSS_WEIGHT = 0.001
    _C.MODEL.ROI_BOX_HEAD.USE_OT = 'BCE'
    _C.MODEL.ROI_BOX_HEAD.USE_DISTILL = True
    _C.MODEL.ROI_BOX_HEAD.REPEAT_K = 3
    _C.MODEL.ROI_BOX_HEAD.REPEAT_FREQ = 0.5
    ...
    _C.MODEL.ROI_BOX_HEAD.ONETOONE_NUM_PROPS = 5
    ...
    _C.MODEL.ROI_BOX_HEAD.OT_LOSS_WEIGHT = 0.1
    _C.MODEL.ROI_BOX_HEAD.SCALE = 100
    _C.MODEL.ROI_BOX_HEAD.TAG_CONFIDENCE = 0.3
    _C.MODEL.ROI_BOX_HEAD.TOP_TAGS = 10
    _C.MODEL.ROI_BOX_HEAD.NEAR_CLASS_THRESH = 0.95

    _C.MODEL.ROI_HEADS.MASK_WEIGHT = 1.0
    _C.MODEL.ROI_HEADS.GRID_FEATURE_LAYER = 0
    _C.MODEL.ROI_HEADS.ONE_CLASS_PER_PROPOSAL = False # For demo only

    _C.MODEL.GRID_ALIGN = CN()
    _C.MODEL.GRID_ALIGN.spatial_dropout = 100
    _C.MODEL.GRID_ALIGN.grid_ot_weight = 0.1
    _C.MODEL.GRID_ALIGN.USE_GROUNDING = False

    _C.MODEL.SHARE_PROJ_V_DIM = 1024
    _C.MODEL.SHARE_PROJ_L_DIM = 512
